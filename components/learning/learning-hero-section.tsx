    ...
    <section className="relative py-20 pt-32 bg-gradient-to-br from-background via-muted to-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-primary mb-6">Learning & Training</h1>

          <p className="text-xl md:text-2xl text-muted-foreground mb-8 leading-relaxed">
            Master cybersecurity skills with our comprehensive training programs designed for students, professionals,
            and enterprises
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            >
              <Link href="/contact">Get Custom Training</Link>
            </Button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-muted-foreground">Course Modules</div>
            </div>
            <div className="text-center">
